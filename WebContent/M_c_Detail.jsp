	...
	<center>
		<aside class="goods">
				<table>
					<tr>
	<div id="container">
		<h1 id="heading">MULLENS BELTED BIKER DENIM JACKET</h1>
		<div id="prod-pic">
			<img src="images/A/c.png" alt="BELTED BIKER DENIM JACKET" id="BELTED BIKER DENIM JACKET" width="500" height="500">
		</div>			
		<div id="desc">
			<ul>
			...
			<video src="video/moc.mp4" controls width="700"></video>								
		</div>
